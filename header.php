<html>
	...
	<nav class="navbar navbar-toggleable-md navbar-light fixed-top" style="background-color:#003399;height:62px;">
		<a href="index.html"><img src="img/logo.jpeg"  height="42" width="200" /></a>
			...
			<div class="navbar-nav">
	  		<div class="container">
				...
				<div class="col-1  offset-1 hover-me" align="center" id="temp">
					<a class="white-color  nav-item nav-link <?php if(isset($page_tab) and $page_tab == "home"){echo "active";}?>" href="index.html" >Home </a>
				</div>
